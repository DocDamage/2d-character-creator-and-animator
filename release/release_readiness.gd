...
const REQUIRED_DOCUMENTS := ["res://docs/guides/USER_GUIDE.md", "res://docs/guides/ASSET_AUTHORING_GUIDE.md", "res://docs/guides/WEAPON_AUTHORING_GUIDE.md", "res://docs/guides/RELEASE_BUILD_GUIDE.md", "res://docs/architecture/RUNTIME_PLUGIN_API.md", "res://release/RELEASE_NOTES.md", "res://release/KNOWN_ISSUES.md", "res://docs/architecture/ASSET_LICENSES.md", "res://docs/architecture/DEPENDENCY_LICENSES.md"]


func build_manifest(version: String = "0.1.0-dev") -> Dictionary:
	return {"version": version, "samples": SampleCatalogScript.new().list_samples(), "documents": REQUIRED_DOCUMENTS.duplicate(), "platform_smoke_required": true}
